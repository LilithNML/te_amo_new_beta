...
const mensajes = {
  ...
  "luna": {
    texto: "<p>Te hablo desde la Luna,<br>no la que cuelga del cielo,<br>sino la que duerme en mi nombre.</p><p>Soy la marea que se agita<br>cuando tu voz toca mi orilla,<br>el silencio que se vuelve canción<br>al roce de tu risa.</p><p>He aprendido a amar mis sombras<br>porque en ellas tú te reflejas,<br>como luz callada,<br>como deseo que no grita<br>pero arde.</p><p>No soy de fuego,<br>pero contigo<br>ardería sin cenizas;<br>sería luna nueva<br>para nacerte cada noche.</p><p>Te miro desde lejos,<br>pero mi alma gira en torno a ti,<br>como si fueras tierra<br>y yo solo supiera<br>amar girando.</p>",
    categoria: "Carta",
    pista: ""
  },
  "sofia": {
    texto: "<p>Mi amor:</p><p>Hoy estaba viendo a nuestras niñas jugar en la sala, con sus risas llenando toda la casa, y no pude evitar pensar en todo lo que hemos vivido para llegar hasta aquí. ¿Te acuerdas cuando solo éramos dos voces que se conocieron en un videojuego? Qué mágico fue que todo empezara allí, tan simple y tan nuestro.</p><p>Miro a nuestras hijas y veo tanto de ti en ellas. La mayor tiene tu forma de mirar el mundo, con esa mezcla de curiosidad y ternura. La pequeña es puro caos y dulzura, como si hubiera heredado la parte más intensa de los dos. Me derrito cuando te llaman papá, con esa vocecita medio ronca de recién despertar. Y tú, tú las miras como si fueran constelaciones.</p><p>Gracias por ser el padre que soñé para ellas, y por seguir siendo mi amor en cada etapa. A veces me cuesta creer que este futuro que imaginábamos en susurros ahora es nuestra realidad. Que nuestras hijas duermen a unos pasos, y que tú sigues aquí, tomándome la mano como el primer día.</p><p>Me haces sentir que todo valió la pena.<br>Te amo. Por nosotros. Por ellas. Por siempre.</p><p>Con todo mi corazón,<br><em>Tu Luna</em></p>",
    categoria: "Carta",
    pista: ""
  },
  "princesa": {
    texto: "<p>Solo quería tomar un momento para agradecerte.<br>Gracias por hacerme sentir como tu princesa, no solo por cómo me llamas, sino por cómo me cuidas, cómo me hablas y cómo me miras.</p><p>Tú haces que lo más simple se sienta especial.<br>Cada mensaje tuyo, cada palabra bonita, cada vez que me haces sonreír cuando ni siquiera sabía que lo necesitaba, todo eso me recuerda lo afortunada que soy de tenerte.</p><p>No necesito un castillo ni una corona. Me basta con tu abrazo, con tu voz diciéndome que me amas, con esa forma tan tuya de hacerme sentir protegida y querida. Contigo, ser tu princesa no es un apodo, es un lugar seguro, un espacio donde me siento amada de verdad.</p><p>Gracias por darme un cuento bonito en este mundo caótico.<br>Gracias por ser mi magia.</p>",
    categoria: "Carta",
    pista: ""
  },
"hazielalancasarezosuna": {
  ...
  "alan": {
    texto: "<p>Alan suena a risa traviesa,<br>a mirada que se escapa y regresa,<br>a cosquillas en medio de la nada,<br>a 'te quiero' dicho con mirada.</p><p>Alan no camina, flota,<br>como si la gravedad no le importara,<br>como si el mundo fuera su parque<br>y yo su rincón favorito.</p><p>Es nombre de niño valiente,<br>de héroe sin capa,<br>de quien conquista<br>con una broma,<br>con un guiño,<br>con una sonrisa que desarma.</p><p>Alan se dice fácil,<br>pero se siente profundo.<br>Porque cuando digo 'mi Alan',<br>no hablo solo de él,<br>hablo de todos los latidos que causa.</p>",
    categoria: "Carta",
    pista: ""
  },
  ...
  "genshin": {
    texto: "<p>Dicen que las almas que deben encontrarse<br>se buscan en todos los mundos,<br>incluso en los que no son reales.</p><p>Te conocí en Teyvat,<br>en un rincón de un mapa lleno de magia,<br>entre espadas celestiales y visiones elementales,<br>pero no fuiste un personaje más,<br>fuiste un presagio.</p><p>Mientras otros buscaban cofres o artefactos,<br>yo encontré algo más valioso:<br>una conexión que ningún NPC podría escribir.</p><p>Tu nombre apareció en la pantalla,<br>como si los dioses del juego supieran<br>que detrás de esos píxeles<br>había algo mucho más humano esperándome.</p><p>No hicimos pacto con arcontes,<br>pero hicimos uno con el corazón,<br>sin mora de por medio,<br>solo risas, combates y miradas escondidas<br>tras personajes con ojos brillantes.</p><p>A veces me pregunto:<br>¿y si Genshin solo fue la excusa del destino?<br>¿y si Mondstadt fue nuestro punto de partida<br>para una historia que no cabe en un juego?</p><p>Porque desde entonces,<br>cuando cierro el juego,<br>no cierro el vínculo.<br>Porque tú no te quedaste en la pantalla.<br>Tú cruzaste.<br>Y me encontraste,<br>aquí, en el mundo real.<br>Y yo te elegí.<br>En Teyvat. En la Tierra. En todos los universos.</p>",
    categoria: "Carta",
    pista: ""
  },
  "raiden": {
    texto: "<p>Si fuera Raiden Shogun,<br>mi poder sería un faro solo para ti.<br>No habría sombra en el mundo que te tocara,<br>ni tormenta capaz de llegar hasta ti<br>sin que yo la disipara con una mirada.</p><p>Mis rayos serían un escudo,<br>cada uno dirigido a mantenerte seguro,<br>y cada golpe de mi espada<br>sería solo para defenderte,<br>para que nunca sientas miedo<br>de lo que está fuera de nuestro alcance.</p><p>Te rodearía con mi calma,<br>con mi fuerza silenciosa<br>que ni el viento podría quebrar,<br>porque a ti te elijo,<br>a ti te guardo,<br>y, como Raiden,<br>mi deber no es solo dominar el trueno,<br>sino ser el refugio donde siempre<br>puedas encontrar paz.</p>",
    categoria: "Carta",
    pista: ""
  },
"chester": {
