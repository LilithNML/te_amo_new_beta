...
const HINT_MESSAGE = "Parece que estás teniendo problemas. Aquí tienes una pista general: ¡Muchos códigos están relacionados con nuestros nuestros recuerdos o fechas especiales! Prueba con palabras clave.";
...
function checkCode() {
  ...
  // Eliminar clases de animación previas del contenido y del input

  contenidoDiv.classList.remove("animated-content");
  ...
  if (data) {
    ...
    // Aplicar la animación de contenido

    contenidoDiv.classList.add("animated-content");

    contenidoDiv.classList.add("show"); // Asegura visibilidad final

    contenidoDiv.addEventListener('animationend', () => {

        contenidoDiv.classList.remove("animated-content");

    }, { once: true }); // Eliminar la clase una vez que la animación termina
    ...
    contenidoDiv.classList.add("show"); // Mostrar el mensaje de error
