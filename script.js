// Este objeto `mensajes` puede crecer mucho. Para una escalabilidad real a más de 200,
// se recomienda encarecidamente externalizarlo a un archivo `data.js` separado
// y cargarlo con un script tag antes de `script.js` o mediante módulos (si el entorno lo permite).
// Ejemplo de estructura de mensaje con categoría y pista
const mensajes = {
  "fortnite": {
  ...
  "kissme": {
    ...
    audio: "assets/audio/holi.mp3",
    categoria: "Audio",
    pista: "Lo que más deseo hacer contigo."
  },
  "tazadecafe": {
    imagen: "assets/images/cafesito.webp",
    categoria: "Imagen",
  ...
  "brawl": {
    descarga: {
      url: "assets/images/mi_diario.webp",
      nombre: "MiDiario.webp",
      textoEnlace: "Descargar mi diario secreto"
    },
    categoria: "Descarga",
  ...
  // Añade más códigos aquí siguiendo esta estructura.
  // Ejemplo: "nuevo_codigo": { texto: "Contenido del nuevo código", categoria: "Nueva Categoría", pista: "Pista del nuevo código" },
};
